...
namespace FerrikuPieShopHRM
{
    internal class Utilities
    {
        private static string directory = @"C:\Users\User\source\repos\FerrikuPieShopHRM\";
        ...
        internal static void SaveEmployees(List<Employee> employees)
        {
            ...
            foreach (var employee in employees)
            {
                ...
                sb.Append($"hourlyRate:{employee.HourlyRated};");
                sb.Append($"type:{type};");
